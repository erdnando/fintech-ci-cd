...
public class Aplicacion extends HttpServlet {
    ...
    private Connection connectDatabase() throws ClassNotFoundException, SQLException {
        ...
        //return DriverManager.getConnection("jdbc:mysql://mimariadb:3306/curso", "root", "admin123");
        return DriverManager.getConnection(System.getenv("URL-BACKEND-FINTECH"), System.getenv("USERDB"), System.getenv("PWDDB"));
    }
